# ![Gomacbot Logo](https://via.placeholder.com/20) Gomacbot
...
```bash
git clone https://github.com/<your-username>/gomacbot.git
cd gomacbot
...
postgres://user:password@localhost:5432/gomacbot?sslmode=disable
